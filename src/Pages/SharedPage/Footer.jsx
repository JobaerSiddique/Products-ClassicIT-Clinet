...
const Footer = () => {
    return (
        ...
        <div className="footer p-10 bg-base-200 text-black container mx-auto px-20 ">
  <aside>
...
<div className=" footer-center p-4 bg-base-300 text-base-content container mx-auto" >
 <aside >
   <p className='flex flex-shrink  justify-center items-center'>Copyright &copy; 2023 - All right reserved by United Collegiate School & Developed By  <span className='ml-3 uppercase'>Munshi Jobaer Siddique</span> </p>
 </aside>
</div>
</footer>
        </div>
